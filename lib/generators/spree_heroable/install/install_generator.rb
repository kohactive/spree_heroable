module SpreeHeroable
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        append_file 'app/assets/javascripts/store/all.js', "//= require store/spree_heroable\n"
        append_file 'app/assets/javascripts/admin/all.js', "//= require admin/spree_heroable\n"
      end

      def add_stylesheets
        inject_into_file 'app/assets/stylesheets/store/all.css', " *= require store/spree_heroable\n", :before => /\*\//, :verbose => true
